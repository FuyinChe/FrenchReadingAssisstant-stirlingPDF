...
cp -f "${ROOT}/packaging/macos/sign-engine-bundle.sh" "${STAGING_DIR}/"
cp -f "${ROOT}/packaging/macos/engine-entitlements.plist" "${STAGING_DIR}/"
...
chmod +x "${STAGING_DIR}/sign-engine-bundle.sh"
